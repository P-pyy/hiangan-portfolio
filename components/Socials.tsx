  ...
  return (
    <div className="mt-6 flex gap-4">
      <a
        ...
        className={`p-5 rounded-lg transition-all duration-300 transform hover:-translate-y-[4px] dark:brightness-75 bg-white/70 dark:bg-black/50 ${hoverClass} ${cardShadowClass}`}
      >
